...
public class CreatePredioWhenAddNewManzana {
	...
	private final FLyrVect sourceLayer;
	...
	public CreatePredioWhenAddNewManzana(FLyrVect layer) {
		...
		try {
			...
			(CatastroUtils.getLayerByName(Preferences.PREDIOS_LAYER_NAME))
					.setActive(true);
			te.startEditing(CatastroUtils
					.getLayerByName(Preferences.PREDIOS_LAYER_NAME));
			pasteFeatures();
			te.stopEditing(CatastroUtils
	...
	private XMLEntity getFeatureXML(IFeature feat,
